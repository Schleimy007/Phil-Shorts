...
async function generateLiveKitToken(roomName, participantName, isBroadcaster = false) {
    ...
    try {
        ...
        console.error("Token Generierung fehlgeschlagen:", e);
        showCustomAlert("Verbindungsfehler", "LiveKit Token konnte nicht erstellt werden.");
        throw e;
    }
}
...
window.joinLiveStream = async function(streamId) {
    ...
    const token = await generateLiveKitToken(streamId, currentUser.uid, false);
