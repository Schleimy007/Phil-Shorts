...
function initResponsiveLayout() {
    ...
    function createPCContainers() { if (!pcSidebar) { pcSidebar = document.createElement('div'); pcSidebar.id = 'pc-nav-sidebar'; pcSidebar.innerHTML = `<div class="logo-area"><img src="https://i.imgur.com/l1luc1q.png" alt="Logo">Phil Shorts</div>`; appContainer.prepend(pcSidebar); } }
